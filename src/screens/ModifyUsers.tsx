...
import { UpdateUsers } from "./pantallitas/UpdateUser";


export type todoPetProps = NativeStackScreenProps<RootStackParamList, 'ModifyUsers'>
...
export const ModifyUsers = ({navigation, route} : todoPetProps) => {
...
// ------------ OBTENER -------------
    ...
    Geeet();
      ...
      const handlePressUpdate = (idUp: string) => {
        // const sendId: ide = JSON.stringify(useId);
          navigation.navigate('UpdateUsers', {idUp})
      }
